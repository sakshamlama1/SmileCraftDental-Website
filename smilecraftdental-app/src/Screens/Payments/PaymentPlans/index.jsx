...
function PaymentPlans() {
    return (
        <div className="payment-plans-screen">
            ...
            <Hero 
                title={"PAYMENT PLANS"} 
                subheading={`At Smile Craft Dental, we offer flexible, interest-free dental payment plans so you can get the treatment you need now and pay it off over time. 
