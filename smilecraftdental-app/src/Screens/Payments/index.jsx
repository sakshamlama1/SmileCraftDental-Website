...
function Payments() {
    return (
        <div className="payments-screen">
            ...
            <Hero 
                title={"Payments"} 
                subheading={"We believe everyone deserves access to quality dental care. At Smile Craft Dental, to make treatments more affordable and stress-free, we offer flexible payment options and interest-free payment plans."} 
            />
