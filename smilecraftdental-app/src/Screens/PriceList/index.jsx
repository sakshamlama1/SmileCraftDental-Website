...
function PriceList() {
    return (
        <div className="price-list-screen">
            ...
            <Hero 
                title={"PRICE LIST"} 
                subheading={`At Smile Craft Dental, we provide transparent pricing for all dental treatments, from routine check-ups and fillings to cosmetic and restorative procedures. 
