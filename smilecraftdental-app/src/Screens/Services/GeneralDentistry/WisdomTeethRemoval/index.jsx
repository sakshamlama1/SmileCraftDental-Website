...
const faqsArray = [
  ...
  },
  {
    ...
    answer: (
      <>
        No. At <b>Smile Craft Dental</b>, we use <b>local anaesthetic</b> to ensure the procedure is
        ...
        <div className="services-content">
          <section className="services-landing">
            ...
            <div className="services-section">
              ...
              <p>At <b>Smile Craft Dental</b>, we follow a careful, step-by-step approach:</p>
